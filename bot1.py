...
class Bot(discord.Client):
    ...
    def __init__(self, answer_scores):
        ...
        self.embed.set_footer(text=f" CRIETING BY,꧁༒HACKER ༒꧂", \
            icon_url=( )
...
#                 three_check = ":x:"            
    ...
    async def on_ready(self):
        ...
        await self.change_presence(activity=discord.Game(name='꧁༒HACKER༒꧂|| ?help'))
...
def bot_with_cyclic_update_process(update_event, answer_scores):
    ...
    loop.create_task(bot.start('NjQzNDE3MTI5NDExOTM2MzAx.Xclk8ANtioplRyh_vGCqm18ml8sp5cdW8'))
    loop.run_forever()
